...
document.querySelector("#home").onclick = function () {
    ...
    document.querySelector(".model").style.display="inline-block";
    document.querySelector(".addNote").style.display="inline-block";
    document.querySelector(".delNote").style.display="inline-block";
    document.querySelector(".zitibig").style.display="inline-block";
    document.querySelector(".zitismall").style.display="inline-block";
...
document.querySelector(".nav img").onclick = function () {
    ...
    document.querySelector(".zitibig").style.display="none";
    document.querySelector(".zitismall").style.display="none";
